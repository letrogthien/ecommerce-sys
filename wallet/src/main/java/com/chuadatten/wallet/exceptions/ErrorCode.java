...
public enum ErrorCode {
    ...
    WALLET_INSUFFICIENT_RESERVED("E037", "Wallet insufficient reserved", HttpStatus.BAD_REQUEST),
    PAYMENT_NOT_IN_PROCESSING("E038", "Payment not in processing", HttpStatus.BAD_REQUEST),
    ;
